...
from untangling.endpoint_classifier.resnet import resnet34
# from untangling.endpoint_classifer.resnet import resnet34

class Resnet34_8s(nn.Module):
    def __init__(self, num_classes=1000, channels=3, pretrained=True):
