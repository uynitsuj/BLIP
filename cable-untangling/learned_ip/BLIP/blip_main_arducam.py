...
def core(fullPipeline, cam, img_rgb, img_rgbd, trace_t, ip_history, normalized_covs, normalized_cable_density, starting_pixels, trace_ct, y_buffer, x_buffer, prev_endpoints, prev_endpoint_idx):
